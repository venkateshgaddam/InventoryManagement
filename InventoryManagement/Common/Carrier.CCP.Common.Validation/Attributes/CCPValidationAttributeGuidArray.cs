...
namespace Carrier.CCP.Common.Validation
{
    ...
    /// </summary>
    public class CCPValidationAttributeGuidArray : CCPValidationAttribute
    {
        /// <summary>
        ...
        protected override ValidationResult IsValid(object value, ValidationContext validationContext)
        {
            ...
            {
                //Check Datatype
                var isValid = CheckPropertyType(validationContext, typeof(Guid[]));
        ...
        private bool IsFieldEmpty(Guid[] val)
        {
            return val.Any(obj => obj == Guid.Empty);
        }
            ...
            ValidatorsValidatorProperty property)
        {
            ...
            var valArray = (Guid[])value;
            if (valArray == null || valArray.Count() <= 0 || IsFieldEmpty(valArray) || !validateRequired.IsValid(value))
            {
