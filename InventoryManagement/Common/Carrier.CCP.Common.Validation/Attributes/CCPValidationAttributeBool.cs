...
{
    /// <summary>
    ///     CCP validation class for bool object
    ///     1.Checks if validationContext is not null
    ///     2.Checks if specified property exists
    ///     3.Checks if specified property is of bool type
    ///     4.Checks if the field is required
    /// </summary>
    public class CCPValidationAttributeBool : CCPValidationAttribute
    {
        public bool IsNullable { get; set; } = false;

        /// <summary>
        ///     To check whether the input bool is a per the dataenhancers rules specified.
        /// </summary>
        /// <param name="value">Type of <see cref="bool" />.</param>
        ...
        protected override ValidationResult IsValid(object value, ValidationContext validationContext)
        {
            ...
            {
                //Check Datatype
                var isValid = CheckPropertyType(validationContext, IsNullable ? typeof(bool?) : typeof(bool));
